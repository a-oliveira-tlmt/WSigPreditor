...
for addr in dfmac[0]:
    ...
    ax.set_title('Medidas e suas Médias Acumuladas')
    legg=ax.legend( (plt1[0], plt2[0]), ('Média acumulada', 'Medidas'), bbox_to_anchor=(1.05, 1), loc='upper left', borderaxespad=0. )
